...
// get a distance reading from the USS
  ...
  int led_brightness1 = map(dist_raw, 100, 200, 255, 0);
  int led_brightness2 = map(dist_raw, 200, 300, 0, 255);
...
// update last sampling time
  ...
  if(dist_raw >= 100 && dist_raw < 200) {
    analogWrite(PIN_LED, led_brightness1);
    Serial.print(led_brightness1);
  }
  else if (dist_raw >= 200) {
    analogWrite(PIN_LED, led_brightness2);
    Serial.print(led_brightness2);
  }
  else {
